    ...
    <div class="row">
        <form class="form-horizontal">
            <div class="form-group col-sm-8 removeleft">
                <div class="row">
                    <div class="col-sm-6">
                        {!! Form::label('start_date', '账单起始日期:', ['class' => 'control-label col-sm-6']) !!}
                        <div class="col-sm-6">
                            {!! Form::text('start_date', null, ['class' => 'form-control']) !!}
                        </div>
                    </div>
                    <div class="col-sm-6 form-inline">
                        {!! Form::label('end_date', '账单截止日期:', ['class' => 'control-label col-sm-6']) !!}
                        <div class="col-sm-6">
...
<script>
    ...
    function initTable() {
        $table.bootstrapTable({
            ...
            url: "{{route('smartchannel.getpayfiles')}}",//这个接口需要处理bootstrap table传递的固定参数
            ...
            onEditableSave: function(field, row, oldValue, $el) {
                ...
                $.ajax({
                    url: '{{ route('smartchannel.updatepayfilefield') }}',
                    type: "post",
        ...
        $remove.click(function () {
            ...
            BootstrapDialog.confirm({
                ...
                callback: function (result) {
                    ...
                    $.ajax({
                        url: '{{ route('smartchannel.removepayfiles') }}',
                        type: "post",
            ...
            BootstrapDialog.show({
                ...
                buttons: [{
                    ...
                    action: function(dialogRef){
                        ...
                        $.ajax({
                            url: '{{ route('smartchannel.checkpayrecords') }}',
                            type: "post",
                            headers: { 'X-CSRF-TOKEN': '{{ csrf_token() }}' },
                            data: {'file_id':ids[0]},
                            success: function(resp) {
    ...
    $(function () {
        ...
        $('#search-form').on('click',function() {
            var opt = {
                url: '{{ route('smartchannel.getpayfiles') }}',
                silent: true,
                query:{
    ...
    $(function(){
        $('#paylist-popup').on('shown.bs.modal', function(){
            var oTable = $('#paylist-table').DataTable({
                ...
                ajax: {
                    //type: 'GET',
                    url: '{!! route('smartchannel.getpaylist') !!}',
