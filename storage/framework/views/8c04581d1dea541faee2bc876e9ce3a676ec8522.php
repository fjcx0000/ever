...
<div class="col-sm-6">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h4 class="box-title"
            >
                <?php echo app('translator')->get('dashboard.tasks.each_month'); ?>
            </h4>
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h4 class="box-title"
            >
                <?php echo app('translator')->get('dashboard.leads.each_month'); ?>
            </h4>
            <div class="box-tools pull-right">
    ...
    <div class="col-lg-12">
        ...
        <div class="info-box bg-yellow">
            ...
            <div class="info-box-content">
                <span class="info-box-text"><?php echo app('translator')->get('dashboard.tasks.all'); ?></span>
                ...
                <div class="progress">
                  ...
                  <span class="progress-description">
                    <?php echo e(number_format($totalPercentageTasks, 0)); ?>% <?php echo app('translator')->get('dashboard.completed'); ?>
                  </span>
            </div>
            <!-- /.info-box-content -->
        </div>
        ...
        <div class="info-box bg-red">
            ...
            <div class="info-box-content">
                ...
                <div class="progress">
                  ...
                  <span class="progress-description">
                    <?php echo e(number_format($totalPercentageLeads, 0)); ?>% <?php echo app('translator')->get('dashboard.completed'); ?>
                  </span>
            </div>
            <!-- /.info-box-content -->
        </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h4 class="box-title"
                >
                    <?php echo app('translator')->get('dashboard.users'); ?>
                </h4>
                <div class="box-tools pull-right">
...
<div class="row movedown">
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text"><?php echo app('translator')->get('dashboard.tasks.completed_today'); ?></span>
                <span class="info-box-number"><?php echo e($completedTasksToday); ?>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text"><?php echo app('translator')->get('dashboard.tasks.created_today'); ?></span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text"><?php echo app('translator')->get('dashboard.leads.completed_today'); ?></span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text"><?php echo app('translator')->get('dashboard.leads.created_today'); ?></span>
