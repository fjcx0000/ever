<?php $__env->startSection('content'); ?>
    <div data-role="page" id="mainPage" data-theme="a">
        <div data-role="header">
            <a href="<?php echo e(route('mstorage.index')); ?>" data-ajax="false" class="ui-btn ui-btn-left ui-icon-home ui-btn-icon-left">返回主页面</a>
            <h1>ERP操作</h1>
        </div>
...
<script>
    $(document).on("pageshow", function(e) {
        $('#btnLoadLocs').on('click', function () {
            $.ajax({
                url: '<?php echo e(route('mstorage.erploadlocs')); ?>',
        ...
        $('#btnUpdateItems').on('click', function () {
            $.ajax({
                url: '<?php echo e(route('mstorage.erpupdateitems')); ?>',
                headers: {'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'},
                type: "post",
                beforeSend: function () {
                    showLoader();
        ...
        $('#btnCheckItems').on('click', function () {
            $.ajax({
                url: '<?php echo e(route('mstorage.erpcheckitems')); ?>',
                type: "get",
                beforeSend: function () {
                    showLoader();
                },
