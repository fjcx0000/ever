...
<?php $__env->startSection('content'); ?>
    ...
    <form class="form-horizontal">
        <div class="form-group col-sm-8 removeleft">
            <div class="row">
                <div class="col-sm-6">
                    <?php echo Form::label('file_startdate', '订单文件起始日期:', ['class' => 'control-label col-sm-6']); ?>

                    <div class="col-sm-6">
                        <?php echo Form::text('file_startdate', null, ['class' => 'form-control']); ?>

                    </div>
                </div>
                <div class="col-sm-6 form-inline">
                    <?php echo Form::label('file_enddate', '订单文件截止日期:', ['class' => 'control-label col-sm-6']); ?>

                    <div class="col-sm-6">
                        <?php echo Form::text('file_enddate', null, ['class' => 'form-control']); ?>
            ...
            <div class="form-group row">
                <div class="col-sm-6 ">
                    <?php echo Form::label('order_id', '订单号:', ['class' => 'control-label col-sm-6']); ?>

                    <div class="col-sm-6">
                        <?php echo Form::text('order_id', null, ['class' => 'form-control']); ?>

                    </div>
                </div>
                <div class="col-sm-6 ">
                    <?php echo Form::label('product_id', '货号:', ['class' => 'control-label col-sm-6']); ?>
            ...
            <div class="row">
                <div class="col-sm-6 ">
                    <?php echo Form::label('isDespatched', '发货状态:', ['class' => 'control-label col-sm-6']); ?>

                    <div class="col-sm-6">
                        <?php echo Form::select('isDespatched', array(''=>'', 'TRUE'=>'已发货', 'FALSE'=>'未发货')); ?>

                    </div>
                </div>
                <div class="col-sm-6 ">
                    <?php echo Form::label('check_flag', '核对状态:', ['class' => 'control-label col-sm-6']); ?>

                    <div class="col-sm-6">
                        <?php echo Form::select('check_flag', array(''=>'', 'N'=>'未核对', '1'=>'核对成功', '2'=>'账单记录不存在', '3'=>'品种或数量不一致')); ?>
...
<script>
    ...
    function initTable() {
        $table.bootstrapTable({
            ...
            url: "<?php echo e(route('smartchannel.getorders')); ?>",//这个接口需要处理bootstrap table传递的固定参数
            ...
            onEditableSave: function(field, row, oldValue, $el) {
                ...
                $.ajax({
                    url: '<?php echo e(route('smartchannel.updateorderfield')); ?>',
                    type: "post",
        ...
        $remove.click(function () {
            ...
            BootstrapDialog.confirm({
                ...
                callback: function (result) {
                    ...
                    $.ajax({
                        url: '<?php echo e(route('smartchannel.removeorders')); ?>',
                        type: "post",
    ...
    $(function () {
        ...
        $('#search-form').on('click',function() {
            var opt = {
                url: '<?php echo e(route('smartchannel.getorders')); ?>',
                silent: true,
                query:{
                    file_startdate: $("#file_startdate").val(),
                    file_enddate: $("#file_enddate").val(),
