    ...
    <nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas-sm" role="navigation">
        <div class="list-group panel">
            ...
            <div class="collapse" id="assistant">
                <a href="<?php echo e(route('excel.index')); ?>" class="list-group-item childlist">Excel文件转换</a>
                <a href="<?php echo e(route('excel.inventoryindex')); ?>" class="list-group-item childlist">零售渠道库存文件</a>
            </div>
